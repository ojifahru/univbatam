                ...
                <div class="row gx-5 col-mb-80">
                    <aside class="sidebar col-lg-12">
                        ...
                        <p>We use this information to provide features of Our Service, to improve and customize Our Service.
                            The information may
                            be uploaded to the Company's servers and/or a Service Provider's server or it may be simply
                        ...
                        <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal
                            ...
                            more about cookies on <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies"
                                target="_blank">TermsFeed
                                website</a> article.</p>
                        ...
                        <ul>
                            <li>
                                ...
                                <p>Purpose: These Cookies are essential to provide You with services available through the
                                    ...
                                    You to use some of its features. They help to authenticate users and prevent fraudulent
                                    use of user
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>To manage Your Account:</strong> to manage Your registration as a user of the
                                    ...
                                    Data You provide can give You access to different functionalities of the Service that
                        ...
                        <p>You may update, amend, or delete Your information at any time by signing in to Your Account, if
                            you have one, and
                            visiting the account settings section that allows you to manage Your personal information. You
                            may also contact Us
                        ...
                        <ul>
                            <li>By email: support@univbatam.ac.id</li>
                        </ul><br>
